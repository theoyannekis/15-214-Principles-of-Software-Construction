...
/**
 * Class that creates an Asterisk Solution Verifier which checks if a proposed solution is a valid solution
 * for a given Asterisk Sudoku puzzle. Implements the SudokuSolutionVerifier Interface
 */
public class AsteriskSolutionVerifier implements SudokuSolutionVerifier {
    ...
    /**
     * Creates a Asterisk Sudoku Verifier
    ...
    /**
     * Checks if the proposed solution is a valid solution of the Asterisk sudoku puzzle
     * @return boolean representing the validity of a proposed solution as a solution to the Asterisk sudoku board
     */
    public boolean isValidSolution(){
        ...
        return isMatch() && isValidAsterisk();
    }
