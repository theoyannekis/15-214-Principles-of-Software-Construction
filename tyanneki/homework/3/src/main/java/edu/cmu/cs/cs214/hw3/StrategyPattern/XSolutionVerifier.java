...
/**
 * Class that creates an X Solution Verifier which checks if a proposed solution is a valid solution
 * for a given X Sudoku puzzle. Implements the SudokuSolutionVerifier Interface
 */
public class XSolutionVerifier implements SudokuSolutionVerifier {
    ...
    /**
     * Checks if the proposed solution is a valid solution of the X sudoku puzzle
     * @return boolean representing the validity of a proposed solution as a solution to the X sudoku board
     */
